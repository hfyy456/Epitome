  ...
  <div class="profile-container">
    <div class="profile">
      <div class="avatar-wrapper">
        <a-avatar :size="110" :src="userInfo.avatar" icon="user" />
      </div>
      ...
      <div class="item-wrapper">
        <ul class="items">
          ...
          <li>100k Photos</li>
          <li>100k <nuxt-link to="/">Follwers</nuxt-link></li>
          <li>100k <nuxt-link to="/">Followings</nuxt-link></li>
        </ul>
      </div>
      <div id="profile-tabs">
        <a-tabs style="margin: 0" default-active-key="1">
          <a-tab-pane key="1" tab="Photos">
            <PhotoContent :srcList="srcList" />
          </a-tab-pane>
          <a-tab-pane key="2" tab="Albums"> Content of Tab Pane 2 </a-tab-pane>
